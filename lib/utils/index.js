                ...
                $('tr').each(function (index, element) {
                    ...
                    $(element)
                        ...
                        if (childIndex === 0) {
                            ...
                            currentFlagDay.date = new Date(currentYear, convertMonthToNumber(month.trim()), Number(date) + 1);
                        }
                        else {
...
var saveScraperDataToFile = function () { return __awaiter(void 0, void 0, void 0, function () {
